...
const LoginPage: React.FC = () => {
    ...
    const [formData, setFormData] = useState<FormData>({ receptionistId: "", password: "" });
    ...
    return (
        <div className='flex justify-between w-11/12 max-w-[1160px] py-12 mx-auto gap-x-12 gap-y-0 text-white'>
            <div className='w-11/12 max-w-[450px] relative'>
                ...
                <button
                    onClick={handleBack}
                    className='absolute top-[-2rem] left-0 flex items-center gap-2 text-richblack-5 hover:text-blue-100 transition-colors duration-200'
                >
                    <IoArrowBack size={24} />
                    <span>Back</span>
                </button>
                ...
                <p className='text-[1.125rem] leading-[1.625rem] mt-4'>
                    <span className='text-richblack-100'>Login to access your dashboard</span>
                    <br/>
                    <span className='text-blue-100 italic'>Secure access for reception staff</span>
                </p>
