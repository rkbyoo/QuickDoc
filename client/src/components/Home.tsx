...
const Home = () => {
  const featureClass = "bg-white p-4 rounded-lg shadow-md flex items-center justify-center text-gray-700 hover:bg-blue-100 transition-colors duration-300";
  ...
  return (
    <div className="max-h-screen bg-gradient-to-b from-blue-100 to-blue-50 flex flex-col items-center justify-center rounded-3xl p-14 h-max">
      <div className="max-w-screen-lg mx-auto text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Welcome to QuickDoc</h1>
        <p className="text-xl text-gray-700 mb-8">Optimize your doctor appointments with ease.</p>
